...
from app.api.v1.endpoints.external_api_router import external_api_router
...
api_v1_router.include_router(external_api_router, prefix="/external", tags=["External API"])
